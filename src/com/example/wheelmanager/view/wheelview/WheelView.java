...
public class WheelView extends View {
	...
	/** 顶部和底部的阴影颜色 */
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF, 0x44FFFFFF, 0x00FFFFFF };
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			...
			centerDrawable = getContext().getResources().getDrawable(R.drawable.two_line);	// 修改为两条线
		}

		if (topShadow == null) {
			
			topShadow = new GradientDrawable(Orientation.TOP_BOTTOM, SHADOWS_COLORS);		// 上边阴影的颜色
		}

		if (bottomShadow == null) {
			
			bottomShadow = new GradientDrawable(Orientation.BOTTOM_TOP, SHADOWS_COLORS);	// 下边阴影的颜色
		}
	...
	private void drawShadows(Canvas canvas) {
		...
		topShadow.setBounds(0, 0, getWidth(), (int)(getHeight() / visibleItems * 1.5));
		topShadow.draw(canvas);

		bottomShadow.setBounds(0, getHeight() - (int)(getHeight() / visibleItems * 1.5), getWidth(), getHeight());
