...
package com.example.wheelmanager.view.wheelitem;
...
import com.example.wheelmanager.adapter.cascade.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF, 0x88FFFFFF, 0x00FFFFFF };
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			...
			centerDrawable = getContext().getResources().getDrawable(R.drawable.two_line);
		}
