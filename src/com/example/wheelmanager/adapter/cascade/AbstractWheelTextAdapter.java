 ...
 */
package com.example.wheelmanager.adapter.cascade;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	public static final int LABEL_COLOR = 0xFFc0c0c4;

	/** Default text size */
	// public int DEFAULT_TEXT_SIZE = 18;
	// public int DEFAULT_TEXT_SIZE=18 ;

	// Text settings
	private int textColor = DEFAULT_TEXT_COLOR;
	private int textSize;// 字体大小单位是像素密度 在本类中查找settextSize设置
	...
	protected AbstractWheelTextAdapter(Context context, int itemResource,
		...
		// DEFAULT_TEXT_SIZE=18;//Integer.parseInt(mContext.getResources().getString(R.string.dialog_textSize));
	...
	protected void configureTextView(TextView view) {
		...
		view.setTextSize(Integer.parseInt(context.getResources().getString(
				R.string.dialog_textSize)));// 设置字体大小
