...
public class SelectPicActivity extends BaseActivity implements PictureCallback {
	...
	private void acquireCredentialsPhoto(Uri uri) {
		...
		//
		// // 获取宽度的比例
		// int scaleWidth = width / getIntent().getIntExtra("screenWidth", 480);
		// int scaleHeight = height / getIntent().getIntExtra("screenHeight",
		// 800);
