...
public class MyAlertDialog_yingye {
	...
	public MyAlertDialog_yingye(Context context) {
	...
	public MyAlertDialog_yingye setTitle(String title) {
		showTitle = true;
		if ("".equals(title)) {
	...
	public MyAlertDialog_yingye setEditText(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
	...
	public MyAlertDialog_yingye setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public MyAlertDialog_yingye setView(View view) {
		showLayout = true;
		if (view == null) {
			showLayout = false;
		} else
	...
	public MyAlertDialog_yingye setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public MyAlertDialog_yingye setPositiveButton(String text,
	...
	public MyAlertDialog_yingye setNegativeButton(String text,
			final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("取消");
