...
public class MyAlertDialog_shopType {
	...
	public MyAlertDialog_shopType(Context context) {
	...
	public MyAlertDialog_shopType builder() {

		// 获取Dialog布局
		View view = LayoutInflater.from(context).inflate(
				R.layout.toast_shop_type_dialog, null);
		...
		lLayout_bg.setLayoutParams(new FrameLayout.LayoutParams((int) (display
				.getWidth() * 1), LayoutParams.WRAP_CONTENT));
		return this;
	}

	public MyAlertDialog_shopType setTitle(String title) {
		showTitle = true;
		if ("".equals(title)) {
	...
	public MyAlertDialog_shopType setEditText(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
	...
	public MyAlertDialog_shopType setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public MyAlertDialog_shopType setView(View view) {
		showLayout = true;
		if (view == null) {
			showLayout = false;
		} else
	...
	public MyAlertDialog_shopType setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public MyAlertDialog_shopType setPositiveButton(String text,
	...
	public MyAlertDialog_shopType setNegativeButton(String text,
			final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("取消");
