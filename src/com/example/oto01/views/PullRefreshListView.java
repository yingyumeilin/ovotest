	...
	public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction())
        {
            case MotionEvent.ACTION_DOWN:
                ...
                System.out.println("x"+mX+"---"+mY);
                break;
            case MotionEvent.ACTION_CANCEL:
            case MotionEvent.ACTION_UP:
//            	int scrollX = PullRefreshListView.this.getScrollX();
//            	int getScrollY = PullRefreshListView.this.getScrollY();
//            	
//            	System.out.println("x"+scrollX+"-========--"+getScrollY);
