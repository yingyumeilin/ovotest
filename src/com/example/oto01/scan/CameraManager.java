...
package com.example.oto01.scan;
...
public final class CameraManager {
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			if (screenResolution != null) {
				...
				int leftOffset = (screenResolution.x / 3) / 2;
				int topOffset = (screenResolution.y - (screenResolution.x - leftOffset)) / 2;
				framingRect = new Rect(leftOffset, topOffset,
						screenResolution.x - leftOffset, topOffset
								+ (screenResolution.x - 2 * leftOffset));
	...
	public Rect getFramingRectInPreview() {
		if (framingRectInPreview == null) {
			...
			// Point cameraResolution = getCameraResolution(parameters,
